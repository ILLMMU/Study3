...
expName = 'OneBack_Digits'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\Rachel\\Desktop\\Auditory 1-Back PsychoPy\\OneBack_Digits_Auditory.py',
...
text_2 = visual.TextStim(win=win, name='text_2',
    text='Welcome to the Auditory One Back Task!',
    font='Arial',
...
myWB = ['OneBackCond.xlsx','OneBackCond-2.xlsx','OneBackCond-3.xlsx','OneBackCond-4.xlsx','OneBackCond-5.xlsx','OneBackCond-6.xlsx']
...
Fixation_2 = visual.TextStim(win=win, name='Fixation_2',
    ...
    languageStyle='LTR',
    depth=-1.0);
Stimulus_2 = sound.Sound('A', secs=0.75, stereo=True)
...
Fixation_3 = visual.TextStim(win=win, name='Fixation_3',
    ...
    languageStyle='LTR',
    depth=-1.0);
Stimulus_3 = sound.Sound('A', secs=0.75, stereo=True)
...
text_4 = visual.TextStim(win=win, name='text_4',
    text='End of the Auditory One Back Task!\n\nThank you for your participation!',
    font='Arial',
    pos=(0, 0), height=0.12, wrapWidth=None, ori=0, 
    color=[1.000,1.000,1.000], colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
...
for thisTrials2 in trials2:
    ...
    routineTimer.add(2.500000)
    # update component parameters for each repeat
    Stimulus_2.setSound(Stim, secs=0.75)
    ...
    while continueRoutine and routineTimer.getTime() > 0:
        ...
        if t >= 0.0 and Background_7.status == NOT_STARTED:
            # keep track of start time/frame for later
            Background_7.tStart = t  # not accounting for scr refresh
        ...
        frameRemains = 0.0 + 2.5- win.monitorFramePeriod * 0.75  # most of one frame period left
        if Background_7.status == STARTED and t >= frameRemains:
            # keep track of stop time/frame for later
        ...
        if t >= 0.5 and Stimulus_2.status == NOT_STARTED:
            ...
            win.callOnFlip(Stimulus_2.play)  # screen flip
        frameRemains = 0.5 + 0.75- win.monitorFramePeriod * 0.75  # most of one frame period left
        if Stimulus_2.status == STARTED and t >= frameRemains:
            # keep track of stop time/frame for later
        ...
        # *StimResp_2* updates
        if t >= 0.5 and StimResp_2.status == NOT_STARTED:
            # keep track of start time/frame for later
            StimResp_2.tStart = t  # not accounting for scr refresh
            ...
            StimResp_2.clearEvents(eventType='keyboard')
        frameRemains = 0.5 + 2- win.monitorFramePeriod * 0.75  # most of one frame period left
        if StimResp_2.status == STARTED and t >= frameRemains:
            # keep track of stop time/frame for later
...
for thisTrials3 in trials3:
    ...
    routineTimer.add(2.500000)
    # update component parameters for each repeat
    Stimulus_3.setSound(Stim, secs=0.75)
    ...
    while continueRoutine and routineTimer.getTime() > 0:
        ...
        if t >= 0.0 and Background_8.status == NOT_STARTED:
            # keep track of start time/frame for later
            Background_8.tStart = t  # not accounting for scr refresh
        ...
        frameRemains = 0.0 + 2.5- win.monitorFramePeriod * 0.75  # most of one frame period left
        if Background_8.status == STARTED and t >= frameRemains:
            # keep track of stop time/frame for later
        ...
        if t >= 0.0 and Fixation_3.status == NOT_STARTED:
            # keep track of start time/frame for later
            Fixation_3.tStart = t  # not accounting for scr refresh
        ...
        if t >= 0.5 and Stimulus_3.status == NOT_STARTED:
            ...
            win.callOnFlip(Stimulus_3.play)  # screen flip
        frameRemains = 0.5 + 0.75- win.monitorFramePeriod * 0.75  # most of one frame period left
        if Stimulus_3.status == STARTED and t >= frameRemains:
            # keep track of stop time/frame for later
        ...
        # *StimResp_3* updates
        if t >= 0.5 and StimResp_3.status == NOT_STARTED:
            # keep track of start time/frame for later
            StimResp_3.tStart = t  # not accounting for scr refresh
            ...
            StimResp_3.clearEvents(eventType='keyboard')
        frameRemains = 0.5 + 2- win.monitorFramePeriod * 0.75  # most of one frame period left
        if StimResp_3.status == STARTED and t >= frameRemains:
            # keep track of stop time/frame for later
